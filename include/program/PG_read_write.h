...
/* metadata_read_hash_table_data: Create a hashmap from the char binary pairs in the files metadata */
int metadata_read_hash_table_data(F_Buf *buf, Data *map, int st_lex, const int st_prg);
